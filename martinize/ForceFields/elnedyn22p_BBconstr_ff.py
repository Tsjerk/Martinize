...
class elnedyn22p:
    ...
    def __init__(self):
        ...
        'HIH': [functions.spl("SC4 SP1 SQd"),     [(0.195,94000), (0.193,None), (0.295,None), (0.216,None), (0.11,None)],                  [(135,100),(115, 50)]],
        'GLN': [functions.spl("Nda D D"),         [(0.300, 2400), (0.280,None)],                                                           [],                             [],         [(0.5,)]],
        'ASN': [functions.spl("Nda D D"),         [(0.250,61000), (0.280,None)],                                                           [],                             [],         [(0.5,)]],
        'SER': [functions.spl("N0 D D"),          [(0.195,94000), (0.280,None)],                                                           [],                             [],         [(0.5,)]],
        'THR': [functions.spl("N0 D D"),          [(0.195,94000), (0.280,None)],                                                           [],                             [],         [(0.5,)]],
        'ARG': [functions.spl("N0 Qd D"),         [(0.250,12500), (0.350,6200), (0.110,None)],                                             [(150,15)]],
        'LYS': [functions.spl("C3 Qd D"),         [(0.250,12500), (0.300,9700), (0.110,None)],                                             [(150,20)]],
        'ASP': [functions.spl("Qa D"),            [(0.255, None), (0.110,None)]],
        'GLU': [functions.spl("Qa D"),            [(0.310, 2500), (0.110,None)]],
        ...
        'HYP': [functions.spl("P1"),              [(0.190, None)]],
    ...
    def bbGetBond(self,r,ca,ss):
        ...
        return ( math.sqrt(functions.distance2(ca[0],ca[1]))/10., None   )
