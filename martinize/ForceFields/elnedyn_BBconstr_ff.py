...
class elnedyn:
    ...
    def __init__(self):
        ...
        self.bbtyp    = {                                                                    #                 #@#
                     ...
                     "PRO": functions.spl(" C5    N0    C5    N0    Na    N0    N0    Na    Na"), # PRO specific    #@#
                     "HYP": functions.spl(" C5    N0    C5    N0    N0    N0    N0    Na    Na")  # HYP specific    #@#
        }                                                                                    #                 #@#
        ## BONDS ##                                                                          #                 
        ...
        'TRP': [functions.spl("SC4 SP1 SC4 SC4"), [(0.255,73000), (0.220,None), (0.250,None), (0.280,None), (0.255,None), (0.35454,None)], [(142,30), (143,20), (104,50)], [(180,200)]],
        'TYR': [functions.spl("SC4 SC4 SP1"),     [(0.335, 6000), (0.335,6000), (0.240,None), (0.310,None), (0.310,None)], [(70,100), (130, 50)]],
        'PHE': [functions.spl("SC4 SC4 SC4"),     [(0.340, 7500), (0.340,7500), (0.240,None), (0.240,None), (0.240,None)], [(70,100), (125,100)]],
        'HIS': [functions.spl("SC4 SP1 SP1"),     [(0.195,91000), (0.193,None), (0.295,None), (0.216,None)],               [(135,100),(115, 50)]],
        ...
        'PRO': [functions.spl("C2"),              [(0.190, None)]],
